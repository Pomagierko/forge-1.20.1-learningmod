...
import net.pomagierko.tutorialmod.item.custom.FuelItem;
...
public class ModItems {
    ...
    public static final RegistryObject<Item> RUBY = ITEMS.register("ruby", () -> new FuelItem(new Item.Properties(), 400));
